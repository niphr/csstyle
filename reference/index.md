...
- [`format_date_as_nor()`](https://niphr.github.io/csstyle/reference/format_date.md)
  ...
  [`format_datetime_as_file()`](https://niphr.github.io/csstyle/reference/format_date.md)
  : Format date and datetime using Norwegian conventions

## Journal formatting (international standards)
...
- [`format_date_as_journal()`](https://niphr.github.io/csstyle/reference/format_date_as_journal.md)
  [`format_datetime_as_journal()`](https://niphr.github.io/csstyle/reference/format_date_as_journal.md)
  [`format_datetime_as_journal_file()`](https://niphr.github.io/csstyle/reference/format_date_as_journal.md)
...
- [`view_html()`](https://niphr.github.io/csstyle/reference/view_html.md)
